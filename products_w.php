            ...
            <div class='row'>
                <div class='triple-column'>
                    <div class='main-column'>
                        ...
                        <h1>Wellness</h1>
                        <p>Our Wellness use parts of a plant, such as the leaves, bark, flowers, roots, or berries to healp live wholesome lives. The products come in many forms, including teas, creams, and powders.</p>
                    </div>
                </div>
            </div>
<div class="container">
