			...
			<table class="table table-bordered table-striped">
				...
				<tbody>
					<?php
						...
						$sql = "SELECT * FROM products WHERE proid IN (".implode(',',$_SESSION['cart']).")";
						$query = $conn->query($sql);
							while($row = mysqli_fetch_array($query, MYSQLI_ASSOC)){
								...
								<tr>
									<td>
										<a href="delete_item.php?id=<?php echo $row['proid']; ?>&index=<?php echo $index; ?>" class="btn btn-danger btn-sm"><span class="glyphicon glyphicon-trash"></span></a>
									</td>
